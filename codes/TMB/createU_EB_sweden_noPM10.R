## Create the negative log posterior (U) for use with TMB when PM10 is not involved
...
write(U.EB, file = "TMB/U_EB_noPM10.cpp")
compile("TMB/U_EB_noPM10.cpp")
dyn.load(dynlib("TMB/U_EB_noPM10"))
